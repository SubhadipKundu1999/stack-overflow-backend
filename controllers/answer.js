...
//       myHeaders.append("apikey", "QUpHXk6DpE60IVivYIwt3wWmtb8Hs6m4");
  
//       let requestOptions = {
//         method: 'POST',
//         redirect: 'follow',
//         headers: myHeaders,
//         body: answerBody // Use the original answerBody here, not raw
//       };
//       answerBody = "what the fuck";
//       console.log(answerBody);
//       const response = await fetch("https://api.apilayer.com/bad_words?censor_character={censor_character}", requestOptions);
//       const result = await response.json();
//       answerBody =await  result.censored_content; // Update answerBody with the cleaned content
//      console.log(answerBody);
